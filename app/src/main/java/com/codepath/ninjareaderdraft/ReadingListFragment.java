 ...
 * {@link ReadingListFragment.OnFragmentInteractionListener} interface
...
public class ReadingListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragmentView = inflater.inflate(R.layout.fragment_reading_list, container, false);

        ArticleArrayAdapter articleArrayAdapter =
                new ArticleArrayAdapter(fragmentView.getContext(), Article.GetFakeArticles());

        ListView lvReadingItems = (ListView) fragmentView.findViewById(R.id.lvArticles);
